...
rm -fr ./build
sam deploy --template-file packaged.yaml --parameter-overrides Lifecycle=Development Environment=D Application=${Application} --capabilities CAPABILITY_IAM --stack-name ${Application}
./cliDeployWebsite.sh